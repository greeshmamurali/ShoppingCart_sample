              ...
              child: Container(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    Text(context.watch<ProductdetailsController>().product?.title.toString() ?? ""
                     ,
                      style: TextStyle(
                          color: Colors.black,
                    ...
                    Text(context.watch<ProductdetailsController>().product?.description.toString() ?? ""
                     ,
          ...
          children: [
            Column(
              ...
              children: [
                ...
                Text(
                  context.watch<ProductdetailsController>().product?.price.toString() ?? "",
                  style: TextStyle(
                      color: Colors.black,
                      fontWeight: FontWeight.bold,
                      fontSize: 20),
