...
class _HomescreenState extends State<Homescreen> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: context.watch<HomeController>().isCategoryLoading?Center(child: CircularProgressIndicator()): Container(
          ...
          children: [
            ...
            SizedBox(
              ...
              child: ListView.separated(
                  ...
                  itemBuilder: (context, index) {
                    return InkWell(
                      ...
                      child: Container(
                        ...
                        child: Text(
                          context.watch<HomeController>().catgories[index],
                  ...
                  itemCount: context.watch<HomeController>().catgories.length),
            ),
            SizedBox(
              height: 15,
            ),
            Expanded(
              child: Padding(
                ...
                child: context.watch<HomeController>().isloading
                    ...
                    : GridView.builder(
                        itemCount:
                            context.watch<HomeController>().shopObj.length,
